...
public class Yeti extends Walker implements CollisionListener {
    ...
    private static final BodyImage image = new BodyImage("data/Enemies/yeti.gif", 5f);

    public Yeti(World world, MainWalker player, float x, float y) {
        super(world, shape);
        addImage(image);
        setGravityScale(5f);
